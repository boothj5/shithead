...
public class AgressiveTest {
	...
	@Test
	public void picksSpecialOverNormalWhenTwoCards() {
		int numCardsPerHand = 3 ;
		Player james = new Aggressive("James", numCardsPerHand) ;
		List<Player> players = new ArrayList<Player>();
		players.add(james) ;
	...
	public void picksHighestTwoCardsWhenTwoSame() {
		Player james = new Aggressive("James", 3) ;
		List<Player> players = new ArrayList<Player>();
		players.add(james) ;
	...
	@Test
	public void picksSpecialOverNormal() {
		int numCardsPerHand = 4 ;
		Player james = new Aggressive("James", numCardsPerHand) ;
		List<Player> players = new ArrayList<Player>();
		players.add(james) ;
		...
		Card hand2 = new Card(Card.Rank.THREE, Card.Suit.DIAMONDS) ;
		Card hand3 = new Card(Card.Rank.KING, Card.Suit.DIAMONDS) ;
		Card hand4 = new Card(Card.Rank.QUEEN, Card.Suit.HEARTS) ;
		james.dealToHand(hand1) ;
		james.dealToHand(hand2) ;
		james.dealToHand(hand3) ;
		james.dealToHand(hand4) ;
		...
		assertThat(choices.size(), is(1)) ;
		assertThat(chosenCard.equals(new Card(Card.Rank.TWO, Card.Suit.SPADES)), is(true)) ;
	}
